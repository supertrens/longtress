...
export const metadata: Metadata = {
  title: "Longtress — Haitian Hair Oil",
  description: "Premium Haitian black castor oil for strong, beautiful, healthy hair. Rooted in tradition, crafted for modern hair care.",
};
